...
def GetData():
    ...
    pangCovReq = Entrez.esearch(db="nucleotide", term="Pangolin Coronavirus MP789 genome", rettype="gb") # Requête pour le Coronavirus MP789 Du Pangolin
    ...
    idList.append(ratCovRes["IdList"][0]) # Identifiant du Sars-Cov 2 Humain => 1916859392
    idList.append(pangCovRes["IdList"][0]) # Identifiant du Sars-Cov 2 Humain => 1817977257
    ...
    SeqIO.write(mesSeq, "seq_covid.gb", "genbank") # Ecriture des séquences au formant GenBank dans le fichier seq_covid.gb
