...
def GetData():
    ...
    MakeLogs("Génération du fichier GenBank réussi")
...
def GetGenSeqGB(gene, listID):
    ...
    filePath = "Fichiers externes" + "/Gène " + gene
    if path.exists(filePath) == False:
        mkdir(filePath)

    SeqIO.write(mesSeq, filePath + "/Gène " + gene + ".gb", "genbank") # Ecriture des séqueces au formant GenBank dans le fichier seq_covid.gb